...
- [GitHub Security Advisories](https://github.com/onlypromarketer/wacrm/security/advisories/new)
  (preferred — keeps the disclosure, fix, and CVE all in one place).
- Email: `info@promarketer.ca` with `[wacrm security]` in the subject.
...
In scope:
- Anything in this repository (`onlypromarketer/wacrm`), including webhook and auth
