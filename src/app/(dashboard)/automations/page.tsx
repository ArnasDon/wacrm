...
export default function AutomationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showTemplates && (
        <section>
          <h2 className="mb-3 text-sm font-semibold text-slate-300">Modelos de início rápido</h2>
      ...
      {automations.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-slate-800 bg-slate-900/40">
          ...
          <p className="mt-3 text-sm font-medium text-white">Nenhuma automação ainda</p>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-white">{pendingDelete?.name}</span> e seu histórico de execução. Esta ação não pode ser desfeita.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
