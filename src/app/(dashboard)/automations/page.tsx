...
export default function AutomationsPage() {
  ...
  async function duplicate(a: Automation) {
    ...
    if (!res.ok) {
      const body = await res.json().catch(() => ({}))
      toast.error(body?.error ?? t("duplicateError"))
      return
    }
  ...
  return (
    <div className="space-y-6">
      ...
      {showTemplates && (
        <section>
          <h2 className="mb-3 text-sm font-semibold text-muted-foreground">{t("templatesHeading")}</h2>
      ...
      <div className="flex items-center gap-4 p-4">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            {automation.is_active && (
              <span className="relative flex h-2 w-2" aria-label={t("activeLabel")}>
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
            ...
            <span className="tabular-nums">
              {t("runsCount", { n: automation.execution_count })}
            </span>
        ...
        <div className="flex items-center gap-3">
          <Switch
            ...
            aria-label={automation.is_active ? t("deactivateLabel") : t("activateLabel")}
          />
