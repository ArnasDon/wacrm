...
function FunnelChart({ steps }: { steps: FunnelStep[] }) {
  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900 p-4">
      <h3 className="mb-4 text-sm font-medium text-white">Funil</h3>
...
export default function BroadcastDetailPage() {
  ...
  function handleExport() {
    ...
    downloadBlob(`transmissao-${safeName}-${broadcastId.slice(0, 8)}.csv`, csv);
  }
          ...
          <Button
            ...
            title={
              broadcast.status === 'sending'
                ? 'Não é possível excluir enquanto uma transmissão está ativamente enviando'
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-slate-800 hover:bg-transparent">
                  ...
                  <TableHead className="text-slate-400">Entregue</TableHead>
                  <TableHead className="text-slate-400">Lido</TableHead>
