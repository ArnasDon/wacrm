  ...
  return (
    <div className="space-y-6">
      ...
      {anySending && (
        <div
          role="progressbar"
          aria-label="Transmissão em progresso"
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-slate-800 hover:bg-transparent">
                ...
                <TableHead className="hidden text-slate-400 lg:table-cell">Entregas</TableHead>
                <TableHead className="hidden text-slate-400 lg:table-cell">Lidas</TableHead>
