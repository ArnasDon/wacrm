    ...
    <div className="space-y-6">
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-border hover:bg-transparent">
              ...
              <TableHead className="text-muted-foreground hidden md:table-cell">{t('columns.email')}</TableHead>
              <TableHead className="text-muted-foreground hidden lg:table-cell">{t('columns.company')}</TableHead>
              <TableHead className="text-muted-foreground hidden md:table-cell">{t('columns.tags')}</TableHead>
              <TableHead className="text-muted-foreground hidden lg:table-cell">{t('columns.created')}</TableHead>
                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      {contact.tags && contact.tags.length > 3 && (
                        <span className="text-[10px] text-muted-foreground">
                          {t('moreTagsCount', { count: contact.tags.length - 3 })}
                        </span>
                      )}
                    </div>
                  </TableCell>
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">{t('deleteContactDialog.title')}</DialogTitle>
            <DialogDescription className="text-muted-foreground">
              {t.rich('deleteContactDialog.description', {
        ...
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">
              {t('deleteContactsDialog.title', { count: selected.size })}
            </DialogTitle>
            <DialogDescription className="text-muted-foreground">
              {t.rich('deleteContactsDialog.description', {
                count: selected.size,
                b: (chunks) => (
                  <span className="text-popover-foreground font-medium">{chunks}</span>
                ),
