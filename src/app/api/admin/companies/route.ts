  ...
  try {
    ...
    const [
      ...
      admin
        .from('accounts')
        .select(
          'id, name, owner_user_id, created_at, suspended_at, suspended_reason, next_payment_due_at, last_marked_paid_at, subscription_amount, subscription_currency, seat_limit, whatsapp_number_limit'
        )
