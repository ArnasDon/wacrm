...
export async function POST(
  ...
  // automations_insert RLS). Account-scoped like the sibling
  // automations/[id] route — any agent+ can duplicate any of the
  // account's automations, not only ones they authored.
  let ctx
  try {
