          ...
          <div className="space-y-3 border-t border-border px-4 py-3">
            ...
            {type === "time_based" && (
              <div>
                ...
                <Input
                  placeholder={t("config.placeholderSchedule")}
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="text-[11px] uppercase tracking-wide text-muted-foreground">
                {isCondition
                  ? t("stepCategory.condition")
                  : step.step_type === "wait"
                  ? t("stepCategory.wait")
                  : t("stepCategory.action")}
              </div>
...
function previewFor(step: BuilderStep, t: ReturnType<typeof useTranslations>): string {
  switch (step.step_type) {
    ...
    case "wait": {
      const amount = step.step_config.amount as number | string | undefined
    ...
    case "condition": {
      ...
      return t("previewWhen", { subject: subjectLabel })
    }
    case "send_webhook":
