    ...
    <div className="space-y-6">
      ...
      {mediaHeaderType && (
        <div className="rounded-xl border border-border bg-card/50 p-4">
          <div className="mb-3 flex items-center gap-2">
            ...
            <p className="text-sm font-medium text-foreground">{t('headerMedia.title')}</p>
          ...
          <p className="mt-1.5 text-xs text-muted-foreground">
            {t('headerMedia.helpText', { type: mediaHeaderType })}
          </p>
          {mediaHeaderType === 'image' &&
          ...
          {headerMediaError && (
            <p className="mt-1.5 text-xs text-amber-300">
              {headerMediaError === 'missing'
                ? t('headerMedia.errorMissing')
                : t('headerMedia.errorInvalid')}
            </p>
          )}
        </div>
      )}
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent className="border-border bg-popover">
                        <SelectItem value="static">{t('mappingOptions.static')}</SelectItem>
                        <SelectItem value="field">{t('mappingOptions.field')}</SelectItem>
                        <SelectItem value="custom_field">
                          {t('mappingOptions.custom_field')}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                            ...
                            placeholder={
                              loadingFields
                                ...
                                : customFields.length === 0
                                  ? t('noCustomFields')
                                  : t('selectCustomFieldPlaceholder')
                            }
                          />
                        </SelectTrigger>
                        <SelectContent className="border-border bg-popover">
      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <p className="text-sm font-medium text-foreground">{t('livePreview.title')}</p>
