...
export function Step3Personalize({
  ...
  const contactFields = [
    { value: 'name', label: t('contactFieldName') },
    { value: 'phone', label: t('contactFieldPhone') },
    { value: 'email', label: t('contactFieldEmail') },
    { value: 'company', label: t('contactFieldCompany') },
  ];
    ...
    <div className="space-y-6">
      ...
      {mediaHeaderType && (
        <div className="rounded-xl border border-border bg-card/50 p-4">
          ...
          <p className="mt-1.5 text-xs text-muted-foreground">
            {t('mediaUrlDesc', { type: mediaHeaderType })}
          </p>
          {mediaHeaderType === 'image' &&
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent className="border-border bg-popover">
                        ...
                        <SelectItem value="field">{t('contactField')}</SelectItem>
      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <p className="text-sm font-medium text-foreground">{t('livePreview')}</p>
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          {t('unmappedWarning', { placeholders: unmappedKeys.join(', ') })}
        </div>
      )}
