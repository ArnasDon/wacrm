...
const KIND_THEME: Record<ActivityKind, KindTheme> = {
  message: { icon: MessageSquare, badge: 'bg-[#35C5AD]/10 text-[#159F99]' },
  contact: { icon: UserPlus, badge: 'bg-primary/10 text-primary' },
  deal: { icon: Briefcase, badge: 'bg-[#0B4F59]/10 text-[#0B4F59]' },
  broadcast: { icon: Radio, badge: 'bg-[#B5DC38]/20 text-[#0B4F59]' },
  automation: { icon: Zap, badge: 'bg-[#35C5AD]/10 text-[#159F99]' },
};
