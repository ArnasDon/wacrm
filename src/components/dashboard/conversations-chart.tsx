  ...
  return (
    <section className="decizyon-card border-border flex h-full flex-col rounded-lg border bg-white/92">
      ...
      <footer className="border-border text-muted-foreground flex items-center gap-4 border-t px-5 py-3 text-xs">
        <LegendDot color="#35C5AD" label={t('incoming')} />
        <LegendDot color="#159F99" label={t('outgoing')} />
      </footer>
    </section>
  );
}
      ...
      {hovered && hover !== null && (
        ...
        >
          ...
          <div className="mt-1 flex flex-col gap-0.5">
            <span className="flex items-center gap-1.5 text-[#35C5AD]">
              <span className="inline-block h-1.5 w-1.5 rounded-full bg-[#35C5AD]" />
