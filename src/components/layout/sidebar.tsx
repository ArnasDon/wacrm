    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'border-sidebar-border bg-sidebar/95 fixed inset-y-0 left-0 z-40 flex h-full w-64 flex-col border-r shadow-[12px_0_44px_rgb(8_32_46_/_0.08)] backdrop-blur-xl',
      ...
      >
        ...
        <div className="border-sidebar-border flex h-16 shrink-0 items-center justify-between gap-2 border-b px-4">
          <Link href="/dashboard" className="flex min-w-0 items-center gap-2">
            <DecizyonLogo className="w-36" priority />
