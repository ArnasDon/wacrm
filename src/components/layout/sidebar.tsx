            ...
            <div className="mb-2 flex items-center gap-2 px-3 text-xs text-muted-foreground">
              ...
              {accountRole
                ? (() => {
                    ...
                    return (
                      <span
                        className={`ml-auto inline-flex shrink-0 items-center gap-1 rounded-full border px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wider ${metadata.className}`}
                      >
