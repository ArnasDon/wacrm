...
describe("lerEspelho", () => {
  ...
  function estado(): EstadoDoDuble {
    return {
      tabelas: {
        cb_asaas_config: [{ account_id: CONTA, status: "conectado", last_sync_at: null, last_sync_attempt_at: null, vencidas_listadas_em: "2026-09-12T14:50:00Z", last_full_sync_at: null, last_error: null }],
        cb_asaas_clientes: [],
