...
export interface Contact {
  ...
  user_id: string;
  account_id: string;
  /** Nullable for WhatsApp username contacts that do not disclose a phone. */
  phone: string | null;
  /** Digits-only form of `phone`, generated by the DB (migration 022)
   *  and unique per account. Read-only. */
  phone_normalized?: string;
  /** Meta business-scoped user ID (BSUID), stable within this business. */
  whatsapp_user_id?: string | null;
  /** Display metadata only; never a contact identity key. */
...
export interface Conversation {
  ...
  whatsapp_recipient_type?: 'phone' | 'bsuid' | null;
